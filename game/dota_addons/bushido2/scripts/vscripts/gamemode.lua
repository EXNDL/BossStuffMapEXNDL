...
require('AI/SimpleAI')
--SimpleAI:MakeInstance( npc_dummy_unit, { spawnPos = unit:GetAbsOrigin(), aggroRange = 500, leashRange = 900 } )
...
function GameMode:OnHeroInGame(hero)
  ...
  if hero:GetUnitName() == 'npc_dota_hero_winter_wyvern' then
          --unit = hero
         SimpleAI:MakeInstance(hero, { spawnPos = hero:GetAbsOrigin(), aggroRange = 500, leashRange = 900 } )
          print "AI Wyvern go"
  end
